          ...
          <section class="contenido_hijo">
              ...
              <article class="button_label">
                  ...
                  <!-- <article class="label_cita">
                      ...
                      <label for="" class="numbercita">0</label>
                  </article> -->
              </article>
              <article class="Tabla">
              <?php
                 ...
                 echo ' <table class="tabla-citas">
                      ...
                      while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td> '. $row['Zona'] . '</td>';
                         ...
                         echo' <td >
                         <button class="botones_agente2 " onclick="editarRegistro(' . $row["id_Agente"] . ')"> 
