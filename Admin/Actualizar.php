...
<body >
    ...
    <!-- Inicio header -->
       ...
       <section class="padre">
          <section class="logo">
              <section class="eslogan">ACTUALIZAR USUARIO </section>
              <section class="img_logo"></section>
          </section>
          <form id="form_registro" name="form_registro" action="../PHP/Actualizar_datos_user.php" method="POST" enctype="multipart/form-data">
              <section class="datos">
                  ...
                  <section class="personales">
                    <div>
                      ...
                      <div>
                          <input type="text" id="nombre" name="nombre" placeholder="Nombre" value="<?php echo $name;?>"><i class="fa-solid fa-user fa-xl"></i>
                      </div>
                      <div>
                          <input type="text" id="apep" name="apep" placeholder="Apellido Paterno" required value="<?php echo $apep;?>"><i class="fa-solid fa-user fa-xl"></i>
                       </div>
                      <div>
                          <input type="text" id="apem" name="apem" placeholder="Apellido Materno" required value="<?php echo $apem;?>"><i class="fa-solid fa-user fa-xl"></i>
                      </div>
                      <div>
                          <input type="number" id="tel" name="tel" placeholder="Teléfono" required value="<?php echo $telefono;?>"> <i class="fa-solid fa-mobile-button fa-2xl"></i>
                      </div>
                      </section>
                      <br>
                  ...
                  <section class="personales">
                      <div>
                          <input type="email" id="email" name="email" placeholder="Correo" required value="<?php echo $Correo;?>"><i class="fa-solid fa-envelope fa-2xl"></i>
                      </div>
                      <div>
                          <input type="text" id="user" name="user" placeholder="Usuario" required value="<?php echo $user;?>"><i class="fa-solid fa-user fa-2xl "></i>
                      </div>
                      <div>
                          <input type="text" id="contra" name="contra" placeholder="Contraseña" required value="<?php echo $pass;?>"><i class="fa-solid fa-key fa-2xl"></i><br>
                       </div>
                  </section>
                  <br>
                  ...
                  <section class="personales">
                    <div>
                        <img class="Ajuste_imagen" src="<?php echo "../Imagenes/Usuarios/".$imagen?>">
                ...
                <section class="personales">
                    ...
                    <select class="selector-sericio" id="rol" name="rol">
                        <option value="Admin" <?php if ($rol == 'Admin') echo 'selected'; ?>>Admin</option>
                        <option value="Agente" <?php if ($rol == 'Agente') echo 'selected'; ?>>Agente</option>
                        <option value="Comercialización" <?php if ($rol == 'Comercialización') echo 'selected'; ?>>Comercializacion</option>
                    </select>
                    </article>
