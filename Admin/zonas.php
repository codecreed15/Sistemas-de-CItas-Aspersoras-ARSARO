    ...
    <header>
      ...
      <section class="Logout"><a href="../PHP/BD/Salir_sesion.php""> <?php echo  
        ...
        <section class="contenido2">    
          ...
          <form method="post" action="../PHP/Registrar_zona.php">
           <article class="entrada_zona">
            <input  id = "Direccion" name="Direccion" placeholder="Ingrese una zona: calle col. ciudad estado" required>
           </article>

           <article class="entrada_zona">
           <input id="Latitud" name="Latitud" placeholder="Latitud" required type="number" step="any" pattern="^[+-]?\d+(\.\d+)?$">
           </article>

           <article class="entrada_zona">
           <input id="Longitud" name="Longitud" placeholder="Longitud" required type="number" step="any" pattern="^[+-]?\d+(\.\d+)?$">
