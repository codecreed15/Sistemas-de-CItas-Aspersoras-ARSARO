...
<head>
    ...
    <title>Cambiar Zona agente</title>
...
<body >
    ...
    <!-- Inicio header -->
       ...
       <section class="padre">
          <section class="logo">
              <section class="eslogan">Cambiar Zona </section>
              <section class="img_logo"></section>
          </section>
          <form id="form_registro" name="form_registro" action="../PHP/Actualizar_zona_agente.php" method="post">
              <section class="datos">
              ...
              <article class="select_servicio">
                        ...
                        <?php                        
                            echo '
                            <input type="number" value="'.$id.'" id="id_agente" name="id_agente" style="display:none">';                     
                        ?> 
                    ...
                    <select class="selector-sericio" id="selectAgente" name="selectAgente">
                        <?php
                          while($row = $result->fetch_assoc()){
                            echo '
                            <option value="'.$row['id_Zona'].'">'.$row['Zona'].' </option>
                            ';
                          } 
