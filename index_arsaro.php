...
<body>
        ...
        <section class="padre">
            ...
            <section class="datos">
                ...
                <!--------------------------------------- FORMULARIO----------------------------------->
                <form id="login" name = "login" method="post" action="PHP/BD/Loggear2.php">
                <section class="entradas">
                    <section class="usr-padre">
                        <input class="user" type="text" class="username" placeholder="Usuario" id="user" name="user" autocomplete="current-username" required> 
                        <i class="fa-solid fa-user fa-xl icon-user"></i>
                    </section>
                   
                    <section>
                        <input class="contra" type="password" class="password" placeholder="Contraseña" id="password" autocomplete="current-password" name="password" required>
