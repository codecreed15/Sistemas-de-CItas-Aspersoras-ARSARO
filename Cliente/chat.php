    ...
    <!-- Inicio header -->
        ...
        <section class="contenido">    
          <section class="contenido_hijo">
           ...
           <article class="Logo"></article> <!--LOGO-->

              <article class="chat-titulo">
                  <h2> Contacte con el Agente de venta de su zona</h2>
              </br>
                  <h4> Nota: Si en caso de que un Agente de venta no se ajuste a su zona ponerse<br>
                     en contacto con: Manuel Jefe de comercialización</h4>
              </article>
                    ...
                    echo '<article class="card">
                              ...
                              <div class="card-body">
                                ...
                                <article class="buton_agregar2">
                                    ...
                                    <button class="btnlogin2" onclick="ingresar_chat(' . $row["id_Agente"] .')">
                                        Chat
