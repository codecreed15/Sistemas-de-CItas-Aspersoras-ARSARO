<?php
  ...
  if (!isset($_SESSION['usuario'])) {
   ...
   $conn = new mysqli('localhost', 'id20807182_root', 'Bgutierrez2018.', 'id20807182_arsaro');
    ...
    $user=$nombre['Usuario'];
     $sql = "SELECT * FROM chat  WHERE (incoming_msg_iid	= '$user' AND outgoing_msg_id = $id) || (incoming_msg_iid	= $id AND outgoing_msg_id = '$user') ORDER BY id_Chat DESC";
        ...
        <section class="contenido2">    
          <section class="contenido_hijo2">
           ...
           <article class="Logo"></article>
              ...
              <input type="text" class="outcoming_id" name="outcoming_id" value="<?php echo $id; ?>" hidden>
              <input type="text" class="incoming_id" name="incoming_id" value="<?php echo $nombre['Usuario']; ?>" hidden >
