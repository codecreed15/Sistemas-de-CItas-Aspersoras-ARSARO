          ...
          <section class="contenido_hijo">
           ...
           <article class="Logo"></article> <!--LOGO-->
              ...
              <article class="chat-titulo">
                  <h2> Contacte con sus clientes</h2>
              ...
              <article class="carrusel">
                ...
                <?php
                    while($row = $result->fetch_assoc()){
                      $variable=$row['Usuario'];
                      echo '<article class="card">
                      <img src="../Imagenes/Usuarios/cliente.jpg" class="" alt="...">
                      <div class="card-body">
                        ...
                        <article class="buton_agregar2">
                            <button class="btnlogin2" onclick="ingresar_chat2(\'' .$variable.'\')">
                                Chat
